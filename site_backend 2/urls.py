...
urlpatterns = [
    ...
    path('active_deals/', views.active_deals_router, name='active_deals_url'),
    ...
    path('master_card?id=<int:master_id>?change_balance', views.master_card_change_balance, name='master_card_change_balance_url'),
    path('master_card?id=<int:master_id>?charge', views.master_card_charge_router, name='master_card_charge_url'),
    path('master_card?id=<int:master_id>?freeze', views.master_card_freeze_router, name='master_card_freeze_url'),
    path('master_card?id=<int:master_id>?unfreeze', views.master_card_unfreeze_router, name='master_card_unfreeze_url'),
    path('master_card?id=<int:master_id>?block', views.master_card_block_user_router, name='master_card_block_url'),
    path('master_card?id=<int:master_id>?unblock', views.master_card_unblock_user_router, name='master_card_unblock_url'),
    path('master_card?id=<int:master_id>?make_excl', views.master_card_make_excl_user_router, name='master_card_make_excl_url'),
    path('master_card?id=<int:master_id>?unmake_excl', views.master_card_unmake_excl_user_router, name='master_card_unmake_ecxl_url'),
